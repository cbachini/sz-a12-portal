...
?>
<div class="mo_ldap_cloud_nav_container">
		<div><a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'default' ), $filtered_current_page_url ) ); ?>" class="mo_ldap_cloud_unset_link_affect mo_ldap_cloud_normal_nav_icons <?php echo strcmp( $active_tab, 'default' ) === 0 ? 'mo_ldap_cloud_active_tab' : ''; ?>">
			<span>
		...
		<div><a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'config_settings' ), $filtered_current_page_url ) ); ?>" class="mo_ldap_cloud_unset_link_affect mo_ldap_cloud_normal_nav_icons <?php echo strcmp( $active_tab, 'config_settings' ) === 0 ? 'mo_ldap_cloud_active_tab' : ''; ?>">
			<span>
				<svg width="25" height="30" viewBox="0 0 34 24" fill="<?php echo strcmp( $active_tab, 'config_settings' ) === 0 ? '#087ae2' : '#000000'; ?>" >
		...
		<div ><a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'auth_logs' ), $filtered_current_page_url ) ); ?>" class="mo_ldap_cloud_unset_link_affect mo_ldap_cloud_normal_nav_icons <?php echo strcmp( $active_tab, 'auth_logs' ) === 0 ? 'mo_ldap_cloud_active_tab' : ''; ?>">
			<span>
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="<?php echo strcmp( $active_tab, 'auth_logs' ) === 0 ? '#087ae2' : '#000000'; ?>">
		...
		<div class="mo_ldap_cloud_side_nav_hr" ><a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'debugger' ), $filtered_current_page_url ) ); ?>" class="mo_ldap_cloud_unset_link_affect mo_ldap_cloud_normal_nav_icons <?php echo strcmp( $active_tab, 'debugger' ) === 0 ? 'mo_ldap_cloud_active_tab' : ''; ?>">
				<span>
				<svg width="24" height="24" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<path d="M74 50L87 74V50H74Z" fill="<?php echo strcmp( $active_tab, 'debugger' ) === 0 ? '#087ae2' : '#000000'; ?>"/>
					<path d="M100 50L87 74V50H100Z" fill="<?php echo strcmp( $active_tab, 'debugger' ) === 0 ? '#087ae2' : '#000000'; ?>"/>
					<path d="M0 51L13 27V51H0Z" fill="<?php echo strcmp( $active_tab, 'debugger' ) === 0 ? '#087ae2' : '#000000'; ?>"/>
					<path d="M26 51L13 27V51H26Z"  fill="<?php echo strcmp( $active_tab, 'debugger' ) === 0 ? '#087ae2' : '#000000'; ?>"/>
				</svg>
				</span>	Troubleshooting
			</a></div>
		<div class="mo_ldap_cloud_nav_premium_section mo_ldap_cloud_column_flex_container">
			<div class="mo_ldap_cloud_premium_title"><a class="mo_ldap_cloud_unset_link_affect" href="https://plugins.miniorange.com/wordpress-ldap-login-cloud" target="_blank">Premium</a></div>
		<div><a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'addons' ), $filtered_current_page_url ) ); ?>" class="mo_ldap_cloud_unset_link_affect mo_ldap_cloud_normal_nav_icons <?php echo strcmp( $active_tab, 'addons' ) === 0 ? 'mo_ldap_cloud_active_tab' : ''; ?>">
			<span>
		...
		<div class="mo_ldap_cloud_other_products_nav_section">
			<a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'other-products' ), $filtered_current_page_url ) ); ?>" class="mo_ldap_cloud_unset_link_affect mo_ldap_cloud_other_product_nav_box">
				<div>
					<img src="<?php echo esc_url( MO_LDAP_CLOUD_IMAGES . 'basket.svg' ); ?>" height="40px" width="40px">
				</div>
			Our Other products
			</a>
		</div>
