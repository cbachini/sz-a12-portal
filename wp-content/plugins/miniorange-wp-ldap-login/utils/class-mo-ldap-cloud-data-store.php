...
if ( ! class_exists( 'MO_LDAP_Cloud_Data_Store' ) ) {
	/**
	 * MO_LDAP_Cloud_Data_Store : Contains data types to store the timezone information.
	 */
	class MO_LDAP_Cloud_Data_Store {

		/**
		 * Var zones for storing timezones
		 *
		 * @var mixed
		 */
